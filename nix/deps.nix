...
[
  ...
  (fetchNuGet {
    pname = "Unicode.net";
    version = "2.0.0";
    hash = "sha256-OkmaGayVPFHQj6XV4idY2MypeoYn/gmxs1IxsQkV8PU=";
  })
  (fetchNuGet {
    pname = "Xabe.FFmpeg";
    version = "5.2.6";
    hash = "sha256-YHhMiHGBy6+uN3Cd0kj0an1FZLiCmgQSpwnVI0Wmtck=";
  })
  (fetchNuGet {
    pname = "Xabe.FFmpeg.Downloader";
    version = "5.2.6";
    hash = "sha256-gtI17odz+l4XBjRKatiDnVBHYEdxK4GO8azCRlF5gCA=";
  })
]
